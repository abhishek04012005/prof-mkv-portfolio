...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const categoryNames: Record<string, string> = {
    'phd-supervision': 'PhD Student Supervision by Prof. Manish K. Verma',
    'mphil-supervision': 'MPhil Student Supervision by Prof. Manish K. Verma',
    'pg-dissertation-supervision': 'Postgraduate Dissertation Supervision by Prof. Manish K. Verma',
  ...
  const categoryDescriptions: Record<string, string> = {
    'phd-supervision': `Prof. Manish K. Verma has supervised ${category.supervision.length} PhD students on research topics including sociology, environment, and sustainable development.`,
    'mphil-supervision': `Prof. Manish K. Verma has supervised ${category.supervision.length} MPhil students in advanced social research and academic studies.`,
    ...
    'organizing-roles': `Prof. Manish K. Verma has held ${category.supervision.length} organizational and academic leadership positions.`,
  ...
  const categoryKeywords: Record<string, string[]> = {
    'phd-supervision': ['PhD supervision', 'doctoral research', 'sociology', 'supervision', 'Prof. Manish K. Verma'],
    'mphil-supervision': ['MPhil supervision', 'postgraduate research', 'social research', 'Prof. Manish K. Verma'],
    'pg-dissertation-supervision': ['dissertation supervision', 'postgraduate', 'research mentorship', 'Prof. Manish K. Verma'],
    'pg-professional-development': ['professional development', 'postgraduate training', 'academic development', 'Prof. Manish K. Verma'],
    'organizing-roles': ['academic leadership', 'organizing roles', 'professional roles', 'Prof. Manish K. Verma'],
    'session-chairing': ['session chairing', 'conference', 'academic leadership', 'Prof. Manish K. Verma'],
  };
  ...
  return {
    ...
    keywords: categoryKeywords[categoryId] || [category.title, 'Prof. Manish K. Verma', 'supervision'],
    openGraph: {
